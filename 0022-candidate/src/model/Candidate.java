...
/**
 * Represents a candidate with basic information.
 * 
 * This class represents a candidate with attributes such as ID, first name, last name,
 * birth date, address, phone number, email, and type of candidate.
 * It provides constructors, getter and setter methods for these attributes,
 * as well as a toString method to display the candidate's details.
 */
